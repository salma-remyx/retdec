...
# Component options.
#
option(RETDEC_ENABLE_ANCHOR_EMITTER "" OFF)
...
foreach(t ${RETDEC_ENABLE})
	set_if_equal(${t} "anchor-emitter" RETDEC_ENABLE_ANCHOR_EMITTER)
...
if (RETDEC_ENABLE_AR_EXTRACTOR
	OR RETDEC_ENABLE_ANCHOR_EMITTER
...
set_if_at_least_one_set(RETDEC_ENABLE_ANCHOR_EMITTER
		RETDEC_ENABLE_ALL
		RETDEC_ENABLE_RETDEC_DECOMPILER)
...
# tests
set_if_all_set(RETDEC_ENABLE_ANCHOR_EMITTER_TESTS
		RETDEC_TESTS
		RETDEC_ENABLE_ANCHOR_EMITTER)
...
set_if_at_least_one_set(RETDEC_ENABLE_GOOGLETEST
		RETDEC_ENABLE_ANCHOR_EMITTER_TESTS
